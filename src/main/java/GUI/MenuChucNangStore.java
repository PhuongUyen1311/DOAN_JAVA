...
public class MenuChucNangStore extends JPanel implements MouseListener{
    ...
    public void init(){
       ...
       chucnangStore.add("Quản lý sản phẩm");
        ...
        imgChucnangStore.add(new ImageIcon("./src/main/java/images/user_icon.png"));
        imgChucnangStore.add(new ImageIcon("./src/main/java/images/shirt_icon.png"));
        imgChucnangStore.add(new ImageIcon("./src/main/java/images/account_icon.png"));
        imgChucnangStore.add(new ImageIcon("./src/main/java/images/customer_icon.png"));
        imgChucnangStore.add(new ImageIcon("./src/main/java/images/product_icon.png"));
        imgChucnangStore.add(new ImageIcon("./src/main/java/images/bill_icon.png"));
        imgChucnangStore.add(new ImageIcon("./src/main/java/images/signout_icon.png"));
