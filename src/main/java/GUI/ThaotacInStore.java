      ...
      x.setBackground(Cacthuoctinh_phuongthuc_chung.light_gray);
        ...
        for(int i=0;i<titleThaotac.length;i++){
           ...
           switch(titleThaotac[i]){
               case "Thêm":
                   icon.setIcon(new ImageIcon("./src/main/java/images/add_icon.png"));
                   break;
               case "Sửa":
                    icon.setIcon(new ImageIcon("./src/main/java/images/edit_icon.png"));
                   break;
               case "Xóa":
                    icon.setIcon(new ImageIcon("./src/main/java/images/remove_icon.png"));
                   break;
                case "Import Excel":
                    icon.setIcon(new ImageIcon("./src/main/java/images/import_icon.png"));
                   break;
                 case "Export Excel":
                    icon.setIcon(new ImageIcon("./src/main/java/images/export_icon.png"));
                   break;
                 case "In PDF":
                    icon.setIcon(new ImageIcon("./src/main/java/images/pdf_icon.png"));
                   break;
